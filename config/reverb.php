...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may define how Reverb applications are managed. Dot.Analytics
    | has a single app identity per environment (REVERB_APP_ID/KEY/SECRET
    | in .env) -- never shared with other Dot platforms.
    |
    */
